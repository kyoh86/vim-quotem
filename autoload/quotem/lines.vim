...
function! quotem#lines#github(range, line1, line2)
  call s:copy_with(a:line1, a:line2, quotem#github#get_url("branch", "%") .. s:url_line(a:range, a:line1, a:line2))
endfunction

function! quotem#lines#github_commit(range, line1, line2)
  call s:copy_with(a:line1, a:line2, quotem#github#get_url("head", "%") .. s:url_line(a:range, a:line1, a:line2))
endfunction
