...
command! -range=% QuotemGithubCommit :call quotem#lines#github_commit(<range>, <line1>, <line2>)
...
nnoremap <silent> <Plug>(quotem-github-commit) :     QuotemGithubCommit<CR>
vnoremap <silent> <Plug>(quotem-github-commit) :'<,'>QuotemGithubCommit<CR>
...
call operator#user#define('quotem-github-commit', 'quotem#operator#github')
